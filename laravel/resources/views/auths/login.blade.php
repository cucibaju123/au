            ...
            <div class="vertical-align-middle">
                <div class="auth-box ">
                    <div class="left">
                        <div class="content">
                            <div class="header">
                                <div class="logo text-center"><img src="{{asset('images/smp.png')}}" style="width:50px;"
                            ...
                            <form class="form-auth-small" action="/postlogin" method="POST">
                                ...
                                <div class="bottom">
                                    <span class="helper-text">Tidak punya akun? <a href="/register">Daftar
                                            disini</a></span>
                                </div>
                            </form>
                        </div>
                    ...
                    <div class="right">
                        ...
                        <div class="content text">
                            ...
                            <h1 class="heading">SMPN 1 Limbangan</h1>
                        </div>
                    </div>
